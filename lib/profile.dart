                    ...
                    ElevatedButton(
                      ...
                      onPressed: () {
                        if (newPasswordController.text == confirmPasswordController.text) {
                          setState(() {
                            password = newPasswordController.text; // เปลี่ยนรหัสผ่าน
                          });
                          ScaffoldMessenger.of(context).showSnackBar(
        ...
        return Dialog(
          ...
          child: Padding(
            ...
            child: Column(
              mainAxisSize: MainAxisSize.min,
              children: [
                Icon(Icons.exit_to_app, size: 60, color: Colors.deepPurpleAccent),
                SizedBox(height: 20),
                Text(
                  "ยืนยันการออกจากระบบ",
                  style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context) => LoginScreen()), // เปลี่ยนไปที่หน้า Login
                        );
                      },
            ...
            Card(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ListTile(
                      title: Text("ชื่อเล่น", style: TextStyle(color: Colors.grey[700])),
                    ...
                    ListTile(
                      title: Text("ชื่อผู้ใช้", style: TextStyle(color: Colors.grey[700])),
                      subtitle: Text(username, style: TextStyle(color: Colors.black)),
                    ),
                    ListTile(
                      title: Text("อีเมล์", style: TextStyle(color: Colors.grey[700])),
                    ...
                    ListTile(
                      title: Text("รหัสผ่าน", style: TextStyle(color: Colors.grey[700])),
